...
namespace Tesla.NET.Requests
{
    ...
    internal static class HttpClientExtensions
    {
        ...
        /// <summary>
        /// Gets the <see cref="IVehicleConfig"/> of the <see cref="IVehicle"/> with the specified
        /// <see cref="IVehicle.Id"/>.
        /// </summary>
        /// <param name="client">The <see cref="HttpClient"/>.</param>
        /// <param name="baseUri">The base <see cref="Uri"/> of the Tesla Owner API.</param>
        ...
        /// The <see cref="IVehicleState"/> of the <see cref="IVehicle"/> with the specified <see cref="IVehicle.Id"/>.
        /// </returns>
        public static Task<IMessageResponse<IResponseDataWrapper<IVehicleConfig>>> GetVehicleConfigAsync(
            this HttpClient client,
            Uri baseUri,
            long vehicleId,
            string accessToken = null,
            CancellationToken cancellationToken = default)
        {
            ...
            Uri requestUri = new Uri(baseUri, $"api/1/vehicles/{vehicleId}/data_request/vehicle_config");

            return
                client
                    .GetWithAuthAsync(requestUri, accessToken, cancellationToken)
                    .ReadJsonAsAsync<IResponseDataWrapper<IVehicleConfig>, ResponseDataWrapper<VehicleConfig>>(
                        cancellationToken);
        }
